...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // First, clear any existing data in the municipalities table
        DB::table('municipalities')->truncate();

        // Insert the new data
        foreach ($municipalitiesData as $municipality) {
    ...
    {
        // Nothing to do here as we can't restore the previous data
    }
};